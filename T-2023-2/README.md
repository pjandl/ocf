...
0. [Instalando MicroPython na Placa](../Instalando-MicroPython-na-Placa.md)
...
5. [Botão com retenção de estado e LED](../05_botao_led_estado.md)
...
6. [Botão com retenção de estado, relê e LED](../06_botao_led_rele.md)
...
7. [Conversão Analógica-Digital e potenciômetro](../07_ADC_pot.md)
> Montagem simples para uso de conversão analógico-digital para controle contínuo. Faz uso de entrada analógica.

8. [Conversão Analógica-Digital, potenciômetro e escala de LEDs](../08_ADC_pot_leds.md)
...
9. [Conversão Analógica-Digital, fotoresistor e escala de LEDs](../09_ADC_ldr_leds.md)
...
10. [Conversão Analógica-Digital, termistor e LED](../10_ADC_ntc.md)
...
11. [Barramento I2C (Inter-Integrated Circuit)](../11_i2c.md)
...
12. [Display OLED I2C](../12_oled_i2c.md)
...
13. [Display OLED e Sensor Barométrico I2C](../13_oled_bmp180_i2c.md)
